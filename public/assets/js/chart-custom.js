...
-----------------------------------------------------------------------*/
    ...
    if (jQuery("#advanced-chart").length) {
        ...
        (chart = new ApexCharts(
            document.querySelector("#advanced-chart"),
            options
        )).render();
        const body = document.querySelector("body");
        if (body.classList.contains("dark")) {
...
-----------------------------------------------------------------------*/
    ...
    if (jQuery("#am-radar-chart").length) {
        am4core.ready(function () {
            ...
            var valueAxis = chart.yAxes.push(new am4charts.ValueAxis());
            valueAxis.renderer.axisFills.template.fill =
...
-----------------------------------------------------------------------*/
    if (
        (jQuery("#high-basicline-chart").length &&
                ...
                series: [
                    {
                        ...
                        yAxis: 1,
                        data: [
                            49.9, 71.5, 106.4, 129.2, 144, 176, 135.6, 148.5,
                    ...
                    },
                    {
                        ...
                        type: "spline",
                        data: [
                            7, 6.9, 9.5, 14.5, 18.2, 21.5, 25.2, 26.5, 23.3,
                            18.3, 13.9, 9.6,
                        ],
                        color: "#ff4b4b",
                        tooltip: {
        ...
        var chart = new Highcharts.Chart({
            ...
            series: [
                {
                    data: [
                        29.9, 71.5, 106.4, 129.2, 144, 176, 135.6, 148.5, 216.4,
                        194.1, 95.6, 54.4,
                    ],
                    color: "#4788ff",
                },
    ...
    if (
        (jQuery("#high-gauges-chart").length &&
            Highcharts.chart(
                "high-gauges-chart",
                {
                    chart: {
            ...
            series: [
                {
                    name: "Male",
                    data: [
                        -2.2, -2.1, -2.2, -2.4, -2.7, -3, -3.3, -3.2, -2.9,
                        -3.5, -4.4, -4.1, -0,
                    ],
                    color: "#4788ff",
                },
    ...
    function getNewSeries(e, t) {
        ...
        lastDate = a;
        for (var n = 0; n < data.length - 10; n++)
    ...
    if (jQuery("#site-trafic-chart").length) {
        ...
        if (typeof ApexCharts !== typeof undefined) {
            var chart = new ApexCharts(
                document.querySelector("#site-trafic-chart"),
                options
            );
            chart.render();
            const body = document.querySelector("body");
...
-----------------------------------------------------------------------*/
    ...
    if (jQuery("#layout-1-chart-01").length) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#layout-1-chart-01"),
            options
        );
        chart.render();
        const body = document.querySelector("body");
    ...
    if (jQuery("#layout-1-chart-02").length) {
        var options = {
            ...
            xaxis: {
                categories: [["India"], ["U.S.A"], ["Canada"], ["Africa"]],
                labels: {
                    style: {
        ...
        var chart = new ApexCharts(
            document.querySelector("#layout-1-chart-02"),
            options
        );
        chart.render();
        const body = document.querySelector("body");
    ...
    if (jQuery("#layout-1-chart-03").length) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#layout-1-chart-03"),
            options
        );
        chart.render();
        const body = document.querySelector("body");
    ...
    if (jQuery("#layout-1-chart-05").length) {
        ...
        const chart = new ApexCharts(
            document.querySelector("#layout-1-chart-05"),
            options
        );
        chart.render();
        const body = document.querySelector("body");
    ...
    if (jQuery("#layout-1-chart-06").length) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#layout-1-chart-06"),
            options
        );
        chart.render();
    }
    ...
    if (jQuery("#layout-2-chart-01").length) {
        ...
        const chart = new ApexCharts(
            document.querySelector("#layout-2-chart-01"),
            options
        );
        chart.render();
        const body = document.querySelector("body");
    ...
    if (jQuery("#layout-2-chart-02").length) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#layout-2-chart-02"),
            options
        );
        chart.render();
        const body = document.querySelector("body");
    ...
    if (jQuery("#layout-3-chart-03").length) {
        ...
        const chart = new ApexCharts(
            document.querySelector("#layout-3-chart-03"),
            options
        );
        chart.render();
        const body = document.querySelector("body");
    ...
    if (jQuery("#layout-3-chart-04").length) {
        ...
        var chart = new ApexCharts(
            document.querySelector("#layout-3-chart-04"),
            options
        );
        chart.render();
        const body = document.querySelector("body");
