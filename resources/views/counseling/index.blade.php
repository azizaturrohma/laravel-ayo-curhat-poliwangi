                                            ...
                                            @foreach ($users as $user)
                                                <div class="tab-pane fade" id="chatbox{{ $user->id }}" role="tabpanel">
                                                    <div class="chat-head">
                                                        <header
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div
                                                                    class="avatar chat-user-profile mr-2 ml-3 rtl-mr-0 rtl-ml-3">
                                                                    <img src="{{ asset('assets/images/pages/user.png') }}"
                                                    ...
                                                    <div class="chat-content scroller">
                                                        @php
                                                            $chats = \App\Models\Counseling::where(
                                                                'sender_id',
                                                                $user->id,
                                                            )
                                                        ...
                                                        @foreach ($chats as $chat)
                                                            <div
                                                                class="Messages {{ $chat->sender_id != auth()->user()->id ? 'chat-left' : '' }}">
                                                                {{--  --}}
                                                                <div class="chat-user">
                                                                    <a class="avatar m-0">
                                                                        <img src="{{ asset('assets/images/pages/user.png') }}"
                                                    ...
                                                    <div class="chat-footer p-3 bg-white">
                                                        <form class="d-flex align-items-center "
                                                            ...
                                                            <input type="text" class="form-control mr-3 rtl-mr-0 rtl-ml-3"
                                                                placeholder="Tulis pesan disini" name="message">
                                                            <button type="submit"
